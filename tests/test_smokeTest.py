...
class TestSmokeTest():
  ...
  def test_homeHeader(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1269, 1399)
  ...
  def test_homeSpotlightsJoinUs(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1269, 1399)
  ...
  def test_join(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Howie\'s Hamburgers")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Head Hamburglar")
